        ...
        className={`
          ...
          ${
            dragging
              ...
              : "border-dark-border dark:border-dark-border light:border-light-border hover:border-brand-blue/60 hover:bg-dark-elevated/50 dark:hover:bg-dark-elevated/50 light:hover:bg-light-elevated"
          }
        `}
      >
        <div
          className={`p-3 rounded-full transition-colors duration-200 ${
            dragging ? "bg-blue-500/20" : "bg-dark-elevated dark:bg-dark-elevated light:bg-light-elevated"
          }`}
        >
          <Upload
            size={24}
            className={dragging ? "text-brand-blue" : "text-gray-400"}
          />
        </div>
        <div className="text-center">
          ...
          <p className="text-xs text-gray-500 mt-1">支持所有格式 · 最大 1GB</p>
        </div>
        <input
          ref={inputRef}
          type="file"
